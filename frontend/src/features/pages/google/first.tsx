  ...
  return (
    <div className="w-full max-w-[448px] bg-white rounded-2xl border border-gray-200 shadow-sm p-10 mx-auto">
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-base text-gray-800">Use your Google Account</p>
      </div>
      ...
      <div className="flex flex-col space-y-6">
        ...
        <a
          ...
          className="text-blue-600 font-medium text-sm hover:bg-blue-50 w-max px-1 py-0.5 rounded cursor-pointer self-start -mt-2"
        >
          Forgot email?
        </a>
        ...
        <div className="text-sm text-gray-600">
          ...
          <a
            href="https://support.google.com/chrome/answer/6130773?hl=fr"
        ...
        <div className="flex justify-between items-center pt-8">
          <a
            href="https://accounts.google.com/lifecycle/steps/signup/"
            className="text-blue-600 font-medium hover:bg-blue-50 px-4 py-2 rounded cursor-pointer"
          >
            Create account
          </a>
          <button
            onClick={handleSubmit}
            className="bg-[#0b57d0] text-white text-sm font-medium px-6 py-2 rounded-full hover:bg-blue-700 hover:shadow-md transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={!email}
          >
            Next
          </button>
